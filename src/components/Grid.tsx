    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          There are a lot of cool framerworks out there like React, Nextjs, expressjs, Graphql, Aceternity, socket.io, Culinery, AWS...
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">Use Nodejs.</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
      </motion.div>
    </motion.div>
  );
